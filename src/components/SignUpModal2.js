      ...
      DataManager.getObjects("users", [
        ...
        (data) => {
          if (data[0]) {
            ...
            DataManager.addObject("users", user).then(
              (user) => {
                  ...
                  <div className="form-group mb-1">
                    <div className="row align-items-end no-gutters">
                      <div className="col-md-6 offset-md-0 col-10 offset-1 p-2">
                        <label htmlFor="sign-up-firstname" className="font-600">
                          Personal
                        </label>
                  ...
                  <div className="form-group mb-1">
                    <div className="row align-items-end no-gutters">
                      <div className="col-md-12 offset-md-0 col-10 offset-1 px-2">
                        ...
                        >
                          <span className="badge badge-info c-link px-2">
                            i
                          </span>
                        </OverlayTrigger>
                        <div className="position-relative">
                  ...
                  <div className="form-group mb-0">
                    <div className="row align-items-end no-gutters">
                      <div className="col-md-12 offset-md-0 col-10 offset-1 p-2">
                        <label htmlFor="sign-up-activity" className="font-600">
                          Activity/Sector
                        </label>
                        <select
