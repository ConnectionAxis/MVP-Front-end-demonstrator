...
class ModalConfirm extends Component {
	...
	show() {
		...
		if( !Util.isEmpty(this.props.confirm.size) )
			size = this.props.confirm.size;

		if( !Util.isEmpty(this.props.confirm.ok) )
			btnOk = this.props.confirm.ok;
	...
	render() {
		return (
			<>
				<Modal show={this.state.showModal} onHide={this.hide} size={this.state.size} centered>
