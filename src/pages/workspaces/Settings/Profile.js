				...
				<div className="d-md-flex mt-1 mb-1">
					<div className="text-center">
						<div className="img-thumbnail d-inline-block">
							<CAvatar width="190" height="190" file={this.state.user.image_profile} alt={this.state.user.id} />
						</div>
						<div>
							<button className="c-btn c-btn-default c-btn-round c-btn-animated mt-3">Edit</button>
						</div>
					</div>
					<div className="flex-fill pl-md-4 input-form">
						<div className="form-group mb-3">
							<label htmlFor="input-firstname">First name</label>
							<label className={"input-label "+(this.state.erFirstname ? "" : "hide")}>Required *</label>
							<Form.Control
								type="text"
								id="input-firstname"
						...
						<div className="form-group mb-3">
							...
							<label className={"input-label "+(this.state.erLastname ? "" : "hide")}>Required *</label>
							<Form.Control
								type="text"
								id="input-lastname"
						...
						<div className="form-group mb-3">
							...
							<label className={"input-label "+(this.state.erActivity ? "" : "hide")}>Required *</label>
							<Form.Control
								type="text"
								id="input-activity"
						...
						<div className="form-group mb-3">
							...
							<label className={"input-label "+(this.state.erCorporate ? "" : "hide")}>Required *</label>
							<Form.Control
								type="text"
								id="input-corporate"
