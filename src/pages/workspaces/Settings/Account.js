		...
		return (
			<div className="input-form px-md-3">
				...
				<div className="form-group mb-2 py-3">
					<button className="c-btn c-btn-default c-btn-round c-btn-animated" onClick={(e) => this.inputChange(e, "change-password")}>Change your password</button>
				</div>
				<div className="row">
				...
				<div>
					...
					<p className="mb-2">Use your third-party accounts to log in to ConAx</p>
					<PinCheckbox
						className="py-2"
						label="Facebook" />
					<PinCheckbox
