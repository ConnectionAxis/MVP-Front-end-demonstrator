  ...
  render() {
    return (
      <div className="input-form px-md-3">
        ...
        <div>
          <PinCheckbox className="py-2" label="Claim your social Networking" />
          <PinCheckbox className="py-2" label="Claim your ConAx Channels" />
          <PinCheckbox className="py-2" label="Featured Logo" />
          <PinCheckbox className="py-2" label="Early access to tools" />
        </div>
        <hr className="my-4" />
