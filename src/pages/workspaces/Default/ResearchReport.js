    ...
    this.state = {
      ...
      reports: [
        ...
        },
        {
          ...
          subtitle:
            "Frameworks and categories&topics are irrelevant to the content of my interests",
        },
        {
          title: "Insincere",
        ...
        },
        {
          title: "Harassment",
          subtitle:
            "Disparaging or adverserial towards a person or institution",
        },
        {
          title: "Spam",
  ...
  procced(e, action) {
    ...
    this.setState({ show: false }, () => {
      if (typeof this.props.onReport === "function" && action === "ok") {
        this.props.onReport(
          this.props.report,
          this.state.reports[this.state.active]
        );
      }
    });
  }
                  ...
                  <div className="form-group" key={i}>
                    <Form.Check type="radio" id={"research-report-" + i}>
                      ...
                      <Form.Check.Label
                        ...
                        htmlFor={"research-report-" + i}
                      >
                        {r.title}
                      </Form.Check.Label>
                      <Form.Control.Feedback
                        type="valid"
                        className="mt-0 p-s text-base"
                      >
                        {r.subtitle}
                      </Form.Control.Feedback>
                    </Form.Check>
