...
class LoginPage extends Component {
  ...
  constructor(props) {
    ...
    this.showSignUpDetails = this.showSignUpDetails.bind(this);
        ...
        <div className="hero-card container align-items-center py-4">
          <div className="hero-card_image hero-card_item px-2">
            ...
            <h2 className="h1 conax-caption font-700 text-curious-blue mt-md-5 mx-sm-2">
              ConAx unify communication space and optimize digital landscape
              across your research activities to promote data-driven science
              toward innovation.
            </h2>
          </div>
          <div className="hero-card_text hero-card_item py-4 px-2 pl-md-5">
            ...
            <div className="mb-4">
              <SignInForm userLogin={this.userLogin} />
              <div className="form-group text-center">
                <a
                  href="#sign-up"
                  className="c-link font-600 text-curious-blue"
