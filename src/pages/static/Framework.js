...
export default class Framework extends Component {
  ...
  componentDidMount() {
    ...
    if (!Util.isEmpty(this.props.id)) {
      DataManager.getObject("frameworks", this.props.id).then(
        (data) => {
          console.log(data);
  ...
  getDate(dt) {
    if (!Util.isEmpty(dt)) return format("{0} days ago", Util.getDaysAgo(dt));
    else return "";
  }
  ...
  render() {
    ...
    return (
      <>
        <NavigationBar staticPage={false} switchPath={this.props.switchPath} />
        <div
          className={`workspace --with-nav d-flex ${
            this.state.error
        ...
        >
          {!this.state.error ? (
            <div className="container px-0">
              <div className="row no-gutters h-100">
                <div className="col-lg-2 col-md-3 pt-3 pt-md-4 col-sm-12 px-3 px-md-0">
                  ...
                  <ul className="pl-3">
                    {t.areas_research.split(",").map((f, i) => (
                      <li className="my-1 p-s" key={i}>
                        {f}
                      </li>
                    ))}
                  </ul>
                ...
                <div className="col-lg-7 col-md-6 col-sm-12 pt-3 pt-md-4 px-3 px-md-4">
                  ...
                  <p className="my-0">
                    uploaded by{" "}
                    <span className="c-link text-curious-blue">
                      {t.author.name}
                    </span>{" "}
                      ...
                      <Dropdown className="conax-nav-dropdown">
                        ...
                        >
                          <Dropdown.Item
                            ...
                            href="#addtoresearch"
                            onClick={(e) =>
                              this.handleAction(e, "addtoresearch")
                            }
                          >
                          ...
                          <Dropdown.Item
                            ...
                            href="#updateresearch"
                            onClick={(e) =>
                              this.handleAction(e, "updateresearch")
                            }
                          >
                          ...
                          <Dropdown.Item
                            ...
                            href="#mergeresearch"
                            onClick={(e) =>
                              this.handleAction(e, "mergeresearch")
                            }
                          >
            ...
            <>
              ...
              <NavLink to="/" className="text-curious-blue c-link">
                Go back to ConAx
              </NavLink>
            </>
          )}
