      ...
      DataManager.getObjects("users", [
        ...
        (data) => {
          if (data[0]) {
            this.setState({
              formDisable: false,
              erMsg: "Already signed up, try to sign in",
              loading: false,
            });
          } else {
            const userData = {
            ...
            DataManager.addObject("users", userData).then(
              (user) => {
  ...
  formValidate(callback) {
    ...
    if (this.state.corporateEmail.length > 0) {
      if (Util.validateEmail(this.state.corporateEmail)) {
        ...
        this.setState({
          erCorpoarateEmail: true,
          erMsg: "Provide valid Corporate Email address",
        });
        valid = false;
      }
    }
      ...
      <>
        ...
        <div className="workspace --with-nav">
          <div className="container py-4">
            <div className="row">
              <div className="col-md-6 offset-md-3 col-12 offset-0">
                <h1 className="h4 font-700 text-base text-center mt-3 mb-4">
                  Create your profile on ConAx to quick connection with sustable
                  frameworks.
                </h1>
                {this.state.welcome ? (
                  ...
                  <div className="input-form text-base">
                    <form id="conax-sign-up">
                      ...
                      <div className="form-group mb-1">
                        <div className="row align-items-end no-gutters">
                          <div className="col-12 px-2">
                            <label
                              htmlFor="sign-up-corporate"
                              className="font-600 mr-1"
                            >
                              Corporate
                            </label>
                            <OverlayTrigger
                              ...
                              overlay={
                                <Popover>
                                  Please enter your institutional details to
                                  optimisation search of your activities
                                </Popover>
                              }
                            >
                              <span className="badge badge-info bg-curious-blue c-link px-2">
                                i
                              </span>
                            </OverlayTrigger>
                            <div className="position-relative">
                        ...
                        <div className="row align-items-end no-gutters">
                          <div className="col-12 p-2">
                            ...
                            <select
                              ...
                              onChange={(ev) =>
                                this.inputChange("activity", ev)
                              }
                            >
                              <option value="Academia">Academia</option>
                              <option value="Enterprise">Enterprise</option>
                              <option value="Startup">Startup</option>
                              <option value="Organization/NCO">
                                Organization/NCO
                              </option>
                            </select>
                          </div>
                      ...
                      <div className="form-group mb-0">
                        <div className="row align-items-end no-gutters">
                          <div className="col-md-6 offset-md-0 col-12 offset-0 p-2">
                            <label htmlFor="sign-up-email" className="font-600">
                              Personal Email
                            </label>
                            <div className="position-relative">
                              <label
                          ...
                          <div className="col-md-6 offset-md-0 col-12 offset-0 p-2">
                            <label
                              htmlFor="sign-up-corporateemail"
                              className="font-600 mr-1"
                            >
                              Corporate Email
                            </label>
                            <OverlayTrigger
                              ...
                              overlay={
                                <Popover>
                                  Please use your corporate email as a quick way
                                  for us to verify that you're affilated with
                                </Popover>
                              }
                            >
                              <span className="badge badge-info bg-curious-blue c-link px-2">
                            ...
                            <div className="position-relative">
                              <label
                                ...
                                className={
                                  "input-label " +
                                  (this.state.erCorpoarateEmail ? "" : "hide")
                                }
                              >
                                Required *
                              </label>
                              <input
                                ...
                                onChange={(ev) =>
                                  this.inputChange("corporateEmail", ev)
                                }
                      ...
                      <div className="form-group mb-1">
                        <div className="row align-items-end no-gutters">
                          <div className="col-md-6 offset-md-0 col-12 offset-0 p-2">
                            ...
                            <div className="position-relative">
                              ...
                              <input
                                ...
                                onChange={(ev) =>
                                  this.inputChange("signPassword", ev)
                                }
                                id="sign-up-password"
                                type="password"
                                name="password"
                          ...
                          <div className="col-md-6 offset-md-0 col-12 offset-0 p-2">
                            <div className="position-relative">
                              <label
                                htmlFor="sign-up-password2"
                                className={
                                  "input-label " +
                                  (this.state.erPassword2 ? "" : "hide")
                                }
                              >
                                Required *
                              </label>
                              <input
                                ...
                                onChange={(ev) =>
                                  this.inputChange("signPassword2", ev)
                                }
                      ...
                      <div
                        id="sign-up-alert"
                        className={
                          "form-group text-center mb-1 " +
                          (this.state.erMsg.length > 0 ? "" : "hide")
                        }
                      >
                        <label className="text-curious-blue">
                          {this.state.erMsg}
                        </label>
                      </div>
          ...
          <footer className="conax-footer">
                    ...
                    <div className="row">
                      <div className="col-6">
                        <div className="text-sm-right text-md-left">
                          <NavLink to="/privacy" className="text-base font-600">
                            About ConAx
                          </NavLink>
                        </div>
                        <div className="text-sm-right text-md-left">
                      ...
                      <div className="col-6">
                        <div>
                          <NavLink to="/terms" className="text-base font-600">
                            Terms of Use
                          </NavLink>
                        </div>
                        <div>
            ...
            <div className="text-center py-3" style={{ fontSize: ".85rem" }}>
              Copyright © 2018 ConAx
            </div>
          </footer>
        </div>
      </>
